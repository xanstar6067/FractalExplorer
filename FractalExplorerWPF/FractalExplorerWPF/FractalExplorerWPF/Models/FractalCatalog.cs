...
public static class FractalCatalog
{
    ...
    [
        ...
        Item("Динамические системы", "Аттрактор Лоренца", "Визуализация классической хаотической системы Лоренца.", "sig_preview_sq512.png", "Lorenz"),
        Item("Динамические системы", "Аттрактор Рёсслера", "Визуализация хаотической системы Рёсслера.", "rossler_preview_sq512.png", "Rossler"),
        Item("Динамические системы", "Логистическое отображение (орбиты)", "Орбитальный график логистического отображения.", "temporary_preview_sq512.png", "LogisticMap"),
        ...
        Item("Динамические системы", "Карта Хенона", "Классическое двумерное отображение Хенона.", "temporary_preview_sq512.png", "Henon"),
        Item("Динамические системы", "Отображение Икэды", "Двумерное нелинейное отображение Икэды.", "temporary_preview_sq512.png", "Ikeda")
    ];
