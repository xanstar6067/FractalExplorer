...
public static class FractalCatalog
{
    ...
    [
        ...
        Item("Геометрические", "L‑системы и черепашья графика", "Редактор аксиом и правил с анимацией: Кох, Гильберт, Леви, Dragon Curve, деревья, растения и Серпинский.", "serpinski_preview_sq512.png", "LSystem"),
        ...
        Item("Аттракторы", "Странные аттракторы", "Облака плотности для аттракторов Клиффорда, Питера де Йонга, Tinkerbell и Gumowski–Mira.", "henon_preview_sq512.png", "Attractors2D")
    ];
