...
public static class FractalCatalog
{
    ...
    [
        ...
        Item(["Фракталы", "Комплексная динамика", "Другие итерационные семейства"], "Фрактал Феникс", "Итерационная система, учитывающая текущее и предыдущее значения Z.", "phoenix_preview_sq512.png"),
