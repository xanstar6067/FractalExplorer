...
public static class FractalCatalog
{
    ...
    [
        ...
        Item("Геометрические", "Аполлонова прокладка", "Рекурсивная упаковка взаимно касающихся окружностей с раскраской по глубине, кривизне или родительской ветви.", "apollonian_preview_sq512.png", "ApollonianGasket"),
