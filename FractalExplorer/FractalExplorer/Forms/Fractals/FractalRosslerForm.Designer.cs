...
{
    partial class FractalRosslerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            _pnlControls.Controls.Add(_nudC, 0, 2);
            _pnlControls.Controls.Add(_lblC, 1, 2);
            ...
            _nudC.Location = new Point(6, 64);
            _nudC.Margin = new Padding(6, 3, 3, 3);
            _nudC.Name = "_nudC";
            _nudC.Size = new Size(116, 23);
            _nudC.TabIndex = 4;
            // 
            // _lblC
            // 
            ...
            _lblC.Location = new Point(128, 61);
            _lblC.Name = "_lblC";
            _lblC.Size = new Size(98, 29);
            _lblC.TabIndex = 5;
            _lblC.Text = "c";
            ...
            Name = "FractalRosslerForm";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Аттрактор Рёсслера";
