    ...
    public partial class LauncherHubForm : Form
    {
        ...
        private void InitializeFractalCatalog()
        {
            ...
            _fractalCatalog.Add(new FractalInfo
            {
                ...
                // Вам нужно будет добавить картинку превью в ресурсы, если её нет, 
                // можно временно использовать null или другую заглушку.
                PreviewImage = Properties.Resources.NovaMandelbrot_preview // Пока используем существующую или добавьте новую
            });
        }
