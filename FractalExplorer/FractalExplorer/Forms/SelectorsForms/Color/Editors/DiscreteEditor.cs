...
{
    /// <summary>
    /// Базовый редактор для дискретного режима окрашивания.
    /// </summary>
    public sealed class DiscreteEditor : UserControl, IColorModeEditor
    {
        private readonly Label _descriptionLabel;

        public DiscreteEditor()
        {
            _descriptionLabel = new Label
            {
                Dock = DockStyle.Fill,
                TextAlign = ContentAlignment.MiddleCenter,
                Text = "Дискретный режим: дополнительных параметров пока нет."
            };
