namespace FractalDraving // Изменено с FractalExplorer на FractalDraving
{
    partial class FractalMondelbrotBurningShip
    {
        ...
        private void InitializeComponent()
        {
            ...
            nudW.Maximum = new decimal(new int[] { 30000, 0, 0, 0 });
            nudW.Minimum = new decimal(new int[] { 100, 0, 0, 0 });
            nudW.Name = "nudW";
            ...
            nudH.Maximum = new decimal(new int[] { 30000, 0, 0, 0 });
            nudH.Minimum = new decimal(new int[] { 100, 0, 0, 0 });
            nudH.Name = "nudH";
            ...
            nudZoom.Minimum = new decimal(new int[] { 1, 0, 0, 196608 });
            ...
            nudThreshold.Minimum = new decimal(new int[] { 1, 0, 0, 0 });
            nudThreshold.Name = "nudThreshold";
            nudThreshold.Size = new Size(120, 23);
            nudThreshold.TabIndex = 1;
            nudThreshold.Value = new decimal(new int[] { 20, 0, 0, 65536 });
            // 
            // nudIterations
            // 
            ...
            nudIterations.Value = new decimal(new int[] { 200, 0, 0, 0 });
            // 
            // canvas2
            // 
