...
namespace FractalExplorer.Engines
{
    public class NewtonFractalEngine
    {
        ...
        // ... (SetFormula, RenderSingleTile, RenderToBitmap остаются без изменений) ...
        ...
        // ... (LerpColor, FindRootsInternal, HsvToRgb остаются без изменений) ...
